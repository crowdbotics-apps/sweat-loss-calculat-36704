...
## Project Structure
    ...
    ├── sweat_loss_calculat_36704  # Django project configurations
...
1. Clone this repo and `cd sweat_loss_calculat_36704`
...
2. Clone this repo and `cd sweat_loss_calculat_36704`
